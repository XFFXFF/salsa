...
fn test_run_0() {
    ...
    db.assert_logs(expect![[r#"
        [
            ...
            "Event { runtime_id: RuntimeId { counter: 0 }, kind: WillExecute { database_key: final_result(MyInput { [salsa id]: 0 }) } }",
            "final_result(MyInput(Id { value: 1 }))",
            "Event { runtime_id: RuntimeId { counter: 0 }, kind: WillCheckCancellation }",
            "Event { runtime_id: RuntimeId { counter: 0 }, kind: WillExecute { database_key: create_tracked(MyInput { [salsa id]: 0 }) } }",
            "create_tracked(MyInput(Id { value: 1 }))",
            "Event { runtime_id: RuntimeId { counter: 0 }, kind: WillCheckCancellation }",
            "Event { runtime_id: RuntimeId { counter: 0 }, kind: WillExecute { database_key: read_maybe_specified(MyTracked { [salsa id]: 0 }) } }",
...
fn test_run_10() {
    ...
    db.assert_logs(expect![[r#"
        [
            ...
            "read_maybe_specified(MyTracked(Id { value: 1 }))",
            "Event { runtime_id: RuntimeId { counter: 0 }, kind: WillCheckCancellation }",
            "Event { runtime_id: RuntimeId { counter: 0 }, kind: WillExecute { database_key: maybe_specified(MyTracked { [salsa id]: 0 }) } }",
...
fn test_run_0_then_5_then_20() {
    ...
    db.assert_logs(expect![[r#"
        [
            "Event { runtime_id: RuntimeId { counter: 0 }, kind: WillCheckCancellation }",
            "Event { runtime_id: RuntimeId { counter: 0 }, kind: WillCheckCancellation }",
            "Event { runtime_id: RuntimeId { counter: 0 }, kind: DidValidateMemoizedValue { database_key: input(MyTracked { [salsa id]: 0 }) } }",
            "Event { runtime_id: RuntimeId { counter: 0 }, kind: WillExecute { database_key: create_tracked(MyInput { [salsa id]: 0 }) } }",
            "create_tracked(MyInput(Id { value: 1 }))",
            "Event { runtime_id: RuntimeId { counter: 0 }, kind: WillCheckCancellation }",
            "Event { runtime_id: RuntimeId { counter: 0 }, kind: WillCheckCancellation }",
            "Event { runtime_id: RuntimeId { counter: 0 }, kind: DidValidateMemoizedValue { database_key: read_maybe_specified(MyTracked { [salsa id]: 0 }) } }",
            "Event { runtime_id: RuntimeId { counter: 0 }, kind: DidValidateMemoizedValue { database_key: final_result(MyInput { [salsa id]: 0 }) } }",
        ]"#]]);
    ...
    db.assert_logs(expect![[r#"
        [
            ...
            "Event { runtime_id: RuntimeId { counter: 0 }, kind: WillExecute { database_key: create_tracked(MyInput { [salsa id]: 0 }) } }",
            "create_tracked(MyInput(Id { value: 1 }))",
            "Event { runtime_id: RuntimeId { counter: 0 }, kind: WillDiscardStaleOutput { execute_key: create_tracked(MyInput { [salsa id]: 0 }), output_key: maybe_specified(MyTracked { [salsa id]: 0 }) } }",
            "Event { runtime_id: RuntimeId { counter: 0 }, kind: WillCheckCancellation }",
            "Event { runtime_id: RuntimeId { counter: 0 }, kind: WillCheckCancellation }",
            "Event { runtime_id: RuntimeId { counter: 0 }, kind: WillExecute { database_key: maybe_specified(MyTracked { [salsa id]: 0 }) } }",
            "maybe_specified(MyTracked(Id { value: 1 }))",
